...
static void mavlink_test_lidar_360_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_lidar_360_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.left_distance = packet_in.left_distance;
        	packet1.right_distance = packet_in.right_distance;
	...
	mavlink_msg_lidar_360_info_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lidar_360_info_pack(system_id, component_id, &msg , packet1.left_distance , packet1.right_distance );
	mavlink_msg_lidar_360_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lidar_360_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.left_distance , packet1.right_distance );
	mavlink_msg_lidar_360_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_lidar_360_info_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lidar_360_info_send(MAVLINK_COMM_1 , packet1.left_distance , packet1.right_distance );
	mavlink_msg_lidar_360_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
